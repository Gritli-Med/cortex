...
# Title: Ms 1 Ucb2
# Generated: Fri Feb  7 14:25:34 2020
##################################################
...
class ms_1_ucb2(gr.top_block):

    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=1000, T_s=150, ar1=1, bs_slots=range(10), control0='ucb:2', cp_ratio=0.25):
        gr.top_block.__init__(self, "Ms 1 Ucb2")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--control0", dest="control0", type="string", default='ucb:2',
        help="Set Control [default=%default]")
    return parser


def main(top_block_cls=ms_1_ucb2, options=None):
    if options is None:

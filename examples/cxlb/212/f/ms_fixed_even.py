...
# Title: Ms Fixed Even
# Generated: Fri Feb  7 14:24:48 2020
##################################################
...
class ms_fixed_even(gr.top_block):
    ...
    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=1000, T_s=150, ar1=1, ar3=1, ar5=1, ar7=1, bs_slots=range(10), control0='0', control1='2', control2='4', control3='6', cp_ratio=0.25):
...
def argument_parser():
    ...
    parser.add_option(
        ...
        help="Set Control [default=%default]")
    parser.add_option(
        "", "--control2", dest="control2", type="string", default='4',
        help="Set Control [default=%default]")
    parser.add_option(
        "", "--control3", dest="control3", type="string", default='6',
        help="Set Control [default=%default]")
    return parser
...
def main(top_block_cls=ms_fixed_even, options=None):
    ...
    tb = top_block_cls(ar1=options.ar1, ar3=options.ar3, ar5=options.ar5, ar7=options.ar7, control0=options.control0, control1=options.control1, control2=options.control2, control3=options.control3)
    tb.start()
    tb.wait()

...
# Title: Ms 2 Ucb08 Basic
# Generated: Fri Feb  7 14:21:46 2020
##################################################
...
class ms_2_ucb08_basic(gr.top_block):

    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=1000, T_s=150, ar1=1, ar3=1, bs_slots=range(10), control0='ucb:0.8', control1='basic', cp_ratio=0.25):
        gr.top_block.__init__(self, "Ms 2 Ucb08 Basic")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--control1", dest="control1", type="string", default='basic',
        help="Set Control [default=%default]")
    return parser


def main(top_block_cls=ms_2_ucb08_basic, options=None):
    if options is None:
        options, _ = argument_parser().parse_args()

    tb = top_block_cls(ar1=options.ar1, ar3=options.ar3, control0=options.control0, control1=options.control1)
    tb.start()
    tb.wait()

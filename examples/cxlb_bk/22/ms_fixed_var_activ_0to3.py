...
# Title: Ms Fixed Var Activ 0To3
# Generated: Thu Feb  6 15:07:49 2020
##################################################
...
class ms_fixed_var_activ_0to3(gr.top_block):
    ...
    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=1000, T_s=150, ar0=0.1, ar1=0.2, ar2=0.3, ar3=0.4, bs_slots=range(10), control0='0', control1='1', control2='2', control3='3', cp_ratio=0.25):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ar0", dest="ar0", type="eng_float", default=eng_notation.num_to_str(0.1),
        help="Set Activation rate [default=%default]")
    parser.add_option(
        "", "--ar1", dest="ar1", type="eng_float", default=eng_notation.num_to_str(0.2),
        help="Set Activation rate [default=%default]")
    parser.add_option(
        "", "--ar2", dest="ar2", type="eng_float", default=eng_notation.num_to_str(0.3),
        help="Set Activation rate [default=%default]")
    parser.add_option(
        "", "--ar3", dest="ar3", type="eng_float", default=eng_notation.num_to_str(0.4),
        help="Set Activation rate [default=%default]")
    parser.add_option(
        "", "--control0", dest="control0", type="string", default='0',
        help="Set Control [default=%default]")
    parser.add_option(
        "", "--control1", dest="control1", type="string", default='1',
        help="Set Control [default=%default]")
    parser.add_option(
        "", "--control2", dest="control2", type="string", default='2',
        help="Set Control [default=%default]")
    parser.add_option(
...
def main(top_block_cls=ms_fixed_var_activ_0to3, options=None):
    if options is None:

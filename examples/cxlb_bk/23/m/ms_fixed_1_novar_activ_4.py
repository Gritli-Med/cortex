...
# Title: Ms Fixed 1 Novar Activ 4
# Generated: Thu Feb  6 15:09:33 2020
##################################################
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ar0", dest="ar0", type="eng_float", default=eng_notation.num_to_str(1),
...
def main(top_block_cls=ms_fixed_1_novar_activ_4, options=None):
    if options is None:
        options, _ = argument_parser().parse_args()

    tb = top_block_cls(ar0=options.ar0, control0=options.control0)
    tb.start()
    tb.wait()

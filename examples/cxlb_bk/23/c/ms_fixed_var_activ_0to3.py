...
# Generated: Thu Feb  6 15:09:55 2020
##################################################
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ar1", dest="ar1", type="eng_float", default=eng_notation.num_to_str(0.3),
        help="Set Activation rate [default=%default]")
    parser.add_option(
        "", "--ar2", dest="ar2", type="eng_float", default=eng_notation.num_to_str(0.5),
        help="Set Activation rate [default=%default]")
    parser.add_option(
        "", "--ar3", dest="ar3", type="eng_float", default=eng_notation.num_to_str(0.7),
        help="Set Activation rate [default=%default]")
    parser.add_option(

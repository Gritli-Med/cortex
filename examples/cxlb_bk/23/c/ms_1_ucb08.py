...
# Title: Ms 1 Ucb08
# Generated: Thu Feb  6 15:10:13 2020
##################################################
...
class ms_1_ucb08(gr.top_block):
    ...
    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=1000, T_s=150, ar1=1, ar3=1, ar5=1, bs_slots=range(10), control0='ucb:0.8', control1='ucb:0.8', control2='ucb:0.8', cp_ratio=0.25):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--control1", dest="control1", type="string", default='ucb:0.8',
        help="Set Control [default=%default]")
    parser.add_option(
        "", "--control2", dest="control2", type="string", default='ucb:0.8',
        help="Set Control [default=%default]")
    return parser
...
def main(top_block_cls=ms_1_ucb08, options=None):
    ...
    tb = top_block_cls(ar1=options.ar1, ar3=options.ar3, ar5=options.ar5, control0=options.control0, control1=options.control1, control2=options.control2)
    tb.start()
    tb.wait()

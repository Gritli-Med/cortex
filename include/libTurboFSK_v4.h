 ...
 * Date: Wed Oct 23 15:46:18 2019
 * Arguments: "-B" "macro_default" "-W" "lib:libTurboFSK_v4" "-T" "link:lib"
 * "-d" "/home/360.1.296-JOE-LPWA/500
 * Development/SimulationMatlab/matlab_TurboFSK/libTurboFSK_v4/for_testing"
...
#ifndef __libTurboFSK_v4_h
#define __libTurboFSK_v4_h 1
...
#ifdef EXPORTING_libTurboFSK_v4
#define PUBLIC_libTurboFSK_v4_C_API __global
#else
#define PUBLIC_libTurboFSK_v4_C_API /* No import statement needed. */
#endif

#define LIB_libTurboFSK_v4_C_API PUBLIC_libTurboFSK_v4_C_API

#elif defined(_HPUX_SOURCE)

#ifdef EXPORTING_libTurboFSK_v4
#define PUBLIC_libTurboFSK_v4_C_API __declspec(dllexport)
#else
#define PUBLIC_libTurboFSK_v4_C_API __declspec(dllimport)
#endif
...
#define LIB_libTurboFSK_v4_C_API
 ...
 */
#ifndef LIB_libTurboFSK_v4_C_API 
#define LIB_libTurboFSK_v4_C_API /* No special import/export declaration */
#endif

extern LIB_libTurboFSK_v4_C_API 
bool MW_CALL_CONV libTurboFSK_v4InitializeWithHandlers(
       mclOutputHandlerFcn error_handler, 
       mclOutputHandlerFcn print_handler);

extern LIB_libTurboFSK_v4_C_API 
bool MW_CALL_CONV libTurboFSK_v4Initialize(void);

extern LIB_libTurboFSK_v4_C_API 
void MW_CALL_CONV libTurboFSK_v4Terminate(void);



extern LIB_libTurboFSK_v4_C_API 
void MW_CALL_CONV libTurboFSK_v4PrintStackTrace(void);
...
extern LIB_libTurboFSK_v4_C_API bool MW_CALL_CONV mlfMainRx(int nargout, mxArray** RxBits, mxArray** crcCheck, mxArray** indsynchro, mxArray* RxSamplesI, mxArray* RxSamplesQ, mxArray* NbBits, mxArray* noiseVar);

extern LIB_libTurboFSK_v4_C_API bool MW_CALL_CONV mlfMainTx(int nargout, mxArray** TxI, mxArray** TxQ, mxArray* infoBits);
